...
<head>
    <title>Masak</title>
    <?php require_once "../_incheader.php";?>
    <style>
        .master-head {
            height: 100vh;
        }
...
<!--Header-->
    <div class="container-fluid master-head" id="masakMainSlide">
        <h1 class="text-header text-center p-4" style="background-color:rgba(255,255,255,.7);">Alumni</h1>
    </div>
...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark sticky-top" id="mainNav">
  ...
  <div class="collapse navbar-collapse" id="navbarNavDropdown">
    <ul class="navbar-nav">
      <li class="nav-item">
        <a class="nav-link" href="../?legacy">Home</a>
      </li>
      <li class="nav-item">
...
<div class="footer container-fluid bg-light text-center p-2">
    <a>&copy; <?php echo date('Y');?> Faisal Hanif. MasakUI v1.0 (deprecated). <a href=".">Use latest version</a>.</a>
</div>
